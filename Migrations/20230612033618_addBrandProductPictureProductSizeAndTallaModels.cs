...
{
    /// <inheritdoc />
    public partial class addBrandProductPictureProductSizeAndTallaModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentageDiscount = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSizes_Tallas_TallaId",
                        column: x => x.TallaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Name_SubCategoryId",
                table: "Products",
                columns: new[] { "Name", "SubCategoryId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizes_ProductId_TallaId",
                table: "ProductSizes",
                columns: new[] { "ProductId", "TallaId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductSizes_TallaId",
                table: "ProductSizes",
                column: "TallaId");

            migrationBuilder.CreateIndex(
                name: "IX_Tallas_ShortName",
                table: "Tallas",
                column: "ShortName",
                unique: true);
        }
